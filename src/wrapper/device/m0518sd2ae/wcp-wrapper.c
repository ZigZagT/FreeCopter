...
int fc_wcp_loop() {
    ...
    uint32_t control = 0;
    for (int i = 0; i < fc_wcp_status_channels.channel_n; ++i) {
        control += fc_wcp_status_channels.channel[i].signal_source;
    }
...
int fc_wcp_send_data(unsigned long fc_args) {
    fc_wcp_send_recv_data_args_t *args = (fc_wcp_send_recv_data_args_t*)fc_args;
    int res;
    uint32_t temp;
...
int fc_wcp_recv_data(unsigned long fc_args) {
    fc_wcp_send_recv_data_args_t *args = (fc_wcp_send_recv_data_args_t*)fc_args;
    int res;
    uint32_t temp;
